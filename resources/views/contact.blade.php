            ...
            <div class="row g-4">
                ...
                <div class="col-md-5">
                    <div class="bg-light p-4 rounded shadow-sm h-100">
                        ...
                        <p class="mb-1"><strong>ชื่อบริษัท:</strong> Phuket Little Tour</p>
                        <p class="mb-1"><strong>โทรศัพท์:</strong> <a href="tel:0624829114">062-482-9114</a></p>
                        <p class="mb-1"><strong>อีเมล:</strong> <a href="mailto:Zee17094@gmail.com" class="me-3">Zee170940@gmail.com</a></p>
                        <p class="mb-3"><strong>ที่อยู่:</strong> -</p>

                        <div class="mt-2">
                            <h6 class="fw-bold">ช่องทางอื่นๆ:</h6>
